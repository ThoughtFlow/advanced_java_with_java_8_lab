...
public class Currying
{
    ...
    {
        System.out.println(curryingFunction.apply(GradeCalcType.AVERAGE).apply(Arrays.asList(.65, .75, .85)));
        System.out.println(curryingFunction.apply(GradeCalcType.BEST).apply(Arrays.asList(.65, .75, .85)));
        System.out.println(curryingFunction.apply(GradeCalcType.WORSE).apply(Arrays.asList(.65, .75, .85)));
    }
